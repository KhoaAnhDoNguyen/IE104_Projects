...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (id === 'PHINDI') {
        ...
        updateProductInfo('CoffeePhin', 'Ảnh/Cà phê/Phin.png', 'Menu / Cafe / Phin', 'Phin', 35000,
        ...
        updateProductInfo('BacXiu', 'Ảnh/Cà phê/BacXiu.png', 'Menu / Cafe / Bạc Xỉu', 'Bạc Xỉu', 40000, 
        ...
        updateProductInfo('Americano', 'Ảnh/Cà phê/Americano.png', 'Menu / Cafe / Americano', 'Americano', 45000, 
        ...
        updateProductInfo('TraXanh', 'Ảnh/Trà/TraXanhDauDo.png', 'Menu / Trà / Trà Xanh', 'Trà Xanh Đậu Đỏ', 55000, 
        ...
        updateProductInfo('TraDao', 'Ảnh/Trà/TraThanhDao.png', 'Menu / Trà / Trà Đào', 'Trà Thanh Đào', 45000, 
        ...
        updateProductInfo('TraVai', 'Ảnh/Trà/TraThachVai.png', 'Menu / Trà / Trà Vải', 'Trà Thanh Vải', 45000, 
        ...
        updateProductInfo('TraThachDao', 'Ảnh/Trà/TraThachDao.png', 'Menu / Trà / Trà Thạch Đào', 'Trà Thạch Đào', 40000, 
        ...
        updateProductInfo('TraSenVang', 'Ảnh/Trà/TraSenVang.png', 'Menu / Trà / Trà Sen Vàng', 'Trà Sen Vàng', 55000, 
        ...
        updateProductInfo('DetoxThanhLoc', 'Ảnh/Detox/DetoxThanhLoc.png', 'Menu / Detox / Detox Thanh Lọc', 'Detox Thanh Lọc', 25000, 
        ...
        updateProductInfo('DetoxGiamCan', 'Ảnh/Detox/detox giam can.jpg', 'Menu / Detox / Detox Giảm Cân', 'Detox Giảm Cân', 25000, 
        ...
        updateProductInfo('Tiramisu', 'Ảnh/Bánh/Tiramisu.png', 'Menu / Bánh / Tiramisu', 'Tiramisu', 30000, 
        ...
        updateProductInfo('Tart', 'Ảnh/Bánh/Tart.png', 'Menu / Bánh / Tart Trứng', 'Tart Trứng', 10000, 
        ...
        updateProductInfo('PannaCotta', 'Ảnh/Bánh/PannaCotta.png', 'Menu / Bánh / Panna Cotta', 'Panna Cotta', 10000, 
        ...
        updateProductInfo('Mousse Cake', 'Ảnh/Bánh/MousseCake.png', 'Menu / Bánh / Mousse Cake', 'Mousse Cake', 30000, 
        ...
        updateProductInfo('BongLan', 'Ảnh/Bánh/bong-lan-trung-muoi.jpg', 'Menu / Bánh / Bông Lan', 'Bông Lan Trứng Muối', 25000, 
        ...
        updateProductInfo('Biscotti', 'Ảnh/Bánh/Bicossti.png', 'Menu / Bánh / Biscotti', 'Biscotti', 40000, 
